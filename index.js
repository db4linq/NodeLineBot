...
var reg_led1_on = regexp().start('led').maybe(' ').must(1).must(' ').end('on').ignoreCase().toRegExp()
var reg_led1_off = regexp().start('led').maybe(' ').must(1).must(' ').end('off').ignoreCase().toRegExp()
