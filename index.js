...
var reg_led1_on = regexp().start('led').maybe(' ').must(1).must(' ').maybe('on').maybe('เปิด').ignoreCase().toRegExp()
var reg_led1_off = regexp().start('led').maybe(' ').must(1).must(' ').maybe('off').maybe('ปิด').ignoreCase().toRegExp()
var reg_led2_on = regexp().start('led').maybe(' ').must(2).must(' ').maybe('on').maybe('เปิด').ignoreCase().toRegExp()
var reg_led2_off = regexp().start('led').maybe(' ').must(2).must(' ').maybe('off').maybe('ปิด').ignoreCase().toRegExp()
