...
var reg_led1_on = regexp().start('led').maybe(' ').maybe(1).must(' ').end('on').ignoreCase().toRegExp()
var reg_led1_off = regexp().start('led').maybe(' ').maybe(1).must(' ').end('off').ignoreCase().toRegExp()
var reg_led2_on = regexp().start('led').maybe(' ').maybe(2).must(' ').end('on').ignoreCase().toRegExp()
var reg_led2_off = regexp().start('led').maybe(' ').maybe(2).must(' ').end('off').ignoreCase().toRegExp()
